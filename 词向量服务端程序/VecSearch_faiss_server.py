...
if __name__ == '__main__':
    ...
    parser.add_argument('-datfile', default='/Users/zhiqiang/Downloads/zq/工作/竹云-建投/词向量服务端程序/keywords.txt', type=str, help='文本数据文件名')  #required=True,
    ...
    project_path = os.path.abspath(os.path.dirname(__file__))
    if not os.path.exists(project_path+"/"+args.npy):
